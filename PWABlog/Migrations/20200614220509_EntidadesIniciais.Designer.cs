...
namespace PWABlog.Migrations
{
    ...
    [Migration("20200614220509_EntidadesIniciais")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PWABlog.ControleDeAcesso.Papel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PWABlog.ControleDeAcesso.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("PWABlog.ControleDeAcesso.Papel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("PWABlog.ControleDeAcesso.Usuario", null)
                        .WithMany()
